$(function() {
  ...
  $('#treeview1').treeview({
    ...
    expandIcon: 'bx bx-plus me-2',
    collapseIcon: 'bx bx-minus me-2',
    nodeIcon: 'bx bx-folder fs-xs me-2',
    data: defaultData
  });
  ...
  $('#treeview4').treeview({
    ...
    expandIcon: 'bx bx-chevron-right fs-xs me-2',
    onhoverColor: "rgba(0, 0, 0, 0.05)",
    selectedBackColor: colors.primary,
    collapseIcon: 'bx bx-chevron-down fs-xs me-2',
    nodeIcon: 'bx bx-bookmark fs-xs me-2',
    data: defaultData
  });
